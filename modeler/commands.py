...
def main():
    ...
    train_parser.add_argument('--embed_size', default=128, type=int, help='Size of character embedding')
    ...
    train_parser.add_argument('--activation', default='tanh', choices=['relu','tanh','sigmoid'], help='Activation func')
    ...
    train_parser.add_argument('--grad_clip', default=0.2, type=float, help='Clipping value for global gradient norm')
